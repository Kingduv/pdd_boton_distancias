...
distanciaMiami = () =>
{
  ...
  /*34.05223, -118.24368 */
    ...
    var latitudMiami=  25.7906500;
    var longitudMiami= -80.1300500;
  ...
  const end = {
    latitude: latitudMiami,
    longitude: longitudMiami
  }

      var distMiami =  haversine(start, end, {unit: 'km'});
        
        distMiami  = distMiami .toFixed(2);
        this.setState({ distanciaMiami: distMiami  });
  }
